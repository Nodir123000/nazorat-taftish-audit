      ...
      <DialogContent className="sm:max-w-lg border-2 border-primary/20">
        <DialogHeader>
          <div className="flex items-start gap-4 mb-4">
            <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-linear-to-br from-blue-500 to-cyan-500 shadow-lg">
              <Rocket className="h-8 w-8 text-white" />
            </div>
            <div className="flex-1">
              <DialogTitle className="text-2xl font-bold bg-linear-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent mb-2">
          ...
          <div className="text-base leading-relaxed space-y-4">
            <div className="space-y-4">
              ...
              <div className="bg-linear-to-r from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
        ...
        <DialogFooter className="flex-col sm:flex-row gap-3 mt-2">
          ...
          <Button
            ...
            className="w-full sm:w-auto bg-linear-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 shadow-lg"
          >
