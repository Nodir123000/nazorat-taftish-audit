    ...
    if (delegate) {
        ...
        return data.map((item: any) => {
            ...
            return {
                ...
                abbreviation: item.abbreviation || shortNameObj.ru || nameObj.abbr_ru,
                abbreviation_uz_latn: item.abbreviation_uz_latn || shortNameObj.uz || nameObj.abbr_uz,
                abbreviation_uz_cyrl: item.abbreviation_uz_cyrl || shortNameObj.uzk || nameObj.abbr_uzk,
                type: item.type || type,
                nameObj: nameObj,
...
export async function getDistricts() {
    ...
    return data.map((d: any) => {
        ...
        return {
            ...
            name_uz_latn: nameObj.uz,
            name_uz_cyrl: nameObj.uzk,
            shortName: shortNameObj.ru || (d.short_name || d.shortName),
            shortNameObj: shortNameObj,
